...
set logscale y
set xrange [0:200000]
plot "exp2.txt" using 1:2 title "bstree" with linespoints ls 1, "exp2.txt" using 1:3 title "hashtab" with linespoints ls 2